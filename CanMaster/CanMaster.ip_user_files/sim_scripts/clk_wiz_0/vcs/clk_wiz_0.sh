...
#
# Generated by Vivado on Thu Jul 18 00:03:11 +0300 2019
...
# Script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2019.1.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../CanMaster.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../CanMaster.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
