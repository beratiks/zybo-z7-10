...
HD_PWD='D:/github_repository/zybo-z7-10/CanMaster/CanMaster.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CanMaster.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CanMaster.tcl -notrace
