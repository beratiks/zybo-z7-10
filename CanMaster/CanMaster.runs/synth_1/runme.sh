...
HD_PWD='D:/github_repository/zybo-z7-10/CanMaster/CanMaster.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CanMaster.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CanMaster.tcl
