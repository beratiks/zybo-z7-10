...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clockDivider_0_led [get_bd_ports led] [get_bd_pins clockDivider_0/led]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clockDivider_0/sys_clk_pin]
