...
HD_PWD='D:/github_repository/zybo-z7-10/ClockDivider/ClockDivider.runs/design_1_clockDivider_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_clockDivider_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_clockDivider_0_0.tcl
