...
proc create_root_design { parentCell } {
  ...
  # Create instance: ledControler_0, and set properties
  set block_name ledControler
  set block_cell_name ledControler_0
  if { [catch {set ledControler_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ledControler_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net btn_0_1 [get_bd_ports btn] [get_bd_pins buttons_0/btn]
  connect_bd_net -net buttons_0_getButton [get_bd_pins buttons_0/getButton] [get_bd_pins ledControler_0/setLed]
  connect_bd_net -net ledControler_0_led [get_bd_ports led] [get_bd_pins ledControler_0/led]
