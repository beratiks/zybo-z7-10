...
HD_PWD='D:/zybo-z10_workspace/project_8/project_8.runs/design_1_buttons_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_buttons_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_buttons_0_0.tcl
