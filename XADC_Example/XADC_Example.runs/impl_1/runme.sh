...
HD_PWD='D:/github_repository/zybo-z7-10/XADC_Example/XADC_Example.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AdcModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AdcModule.tcl -notrace
