...
HD_PWD='D:/github_repository/zybo-z7-10/XADC_Example/XADC_Example.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AdcModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AdcModule.tcl
