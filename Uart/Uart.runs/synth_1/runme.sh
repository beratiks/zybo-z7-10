...
HD_PWD='C:/Users/yildi/Desktop/Uart/Uart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UartTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UartTop.tcl
