...
HD_PWD='D:/github_repository/zybo-z7-10/Uart/Uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UartReceiver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UartReceiver.tcl -notrace
