...
HD_PWD='C:/Users/yildi/Desktop/Uart/Uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UartTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UartTop.tcl -notrace
