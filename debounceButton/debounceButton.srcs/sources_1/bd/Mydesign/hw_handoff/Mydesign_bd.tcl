...
################################################################
# This is a generated script based on design: Mydesign
#
...
# source Mydesign_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# buttonController, deBouncer, ledController
...
proc create_root_design { parentCell } {
  ...
  set block_cell_name buttonController_0
  if { [catch {set buttonController_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $buttonController_0 eq "" } {
  ...
  connect_bd_net -net btn_0_1 [get_bd_ports btn] [get_bd_pins buttonController_0/btn]
  connect_bd_net -net buttonController_0_getButton [get_bd_pins buttonController_0/getButton] [get_bd_pins deBouncer_0/getButton]
  connect_bd_net -net deBouncer_0_setLed [get_bd_pins deBouncer_0/setLed] [get_bd_pins ledController_0/setLed]
