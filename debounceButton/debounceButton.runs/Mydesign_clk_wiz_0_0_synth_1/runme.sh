...
HD_PWD='D:/github_repository/zybo-z10/debounceButton/debounceButton.runs/Mydesign_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mydesign_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mydesign_clk_wiz_0_0.tcl
