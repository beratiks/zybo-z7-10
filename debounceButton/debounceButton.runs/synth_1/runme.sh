...
HD_PWD='D:/github_repository/zybo-z10/debounceButton/debounceButton.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mydesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mydesign_wrapper.tcl
