...
HD_PWD='D:/github_repository/zybo-z10/debounceButton/debounceButton.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mydesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mydesign_wrapper.tcl -notrace
