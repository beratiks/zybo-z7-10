...
HD_PWD='D:/github_repository/zybo-z7-10/I2C_PCF8574/I2C_PCF8574.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log I2CTopModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source I2CTopModule.tcl -notrace
