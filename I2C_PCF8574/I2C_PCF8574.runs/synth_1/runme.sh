...
HD_PWD='D:/github_repository/zybo-z7-10/I2C_PCF8574/I2C_PCF8574.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log I2CTopModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source I2CTopModule.tcl
