...
HD_PWD='C:/Users/yildi.DESKTOP-254I58R/Desktop/vivado_proj/Zybo-Z7-10-Pmod-VGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PictureDriver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PictureDriver.tcl
