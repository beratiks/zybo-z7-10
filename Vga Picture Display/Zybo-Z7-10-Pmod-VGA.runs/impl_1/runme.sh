...
HD_PWD='C:/Users/yildi.DESKTOP-254I58R/Desktop/vivado_proj/Zybo-Z7-10-Pmod-VGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PictureDriver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PictureDriver.tcl -notrace
